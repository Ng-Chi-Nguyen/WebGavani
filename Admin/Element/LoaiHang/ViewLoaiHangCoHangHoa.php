<?php
   ...
   if(isset($_GET['idLoaiHang'])){
      ...
      // echo $idLoaiHang;
      $List_HH = $HH->getHangHoaByLoaiHang($idLoaiHang);
      $List_LH = $HH->IdLoaiHang($idLoaiHang);
   }
?>
<form action="./Element/HangHoa/XuLy.php?reqact=addNewtuLoaiHang" class="hangHoa" method="post" enctype="multipart/form-data">
   ...
   <table>
      ...
      <div class="mg-bottom">
         ...
         <select name="idLoaiHang">
               <option value="<?php echo $List_LH->idLoaiHang; ?>"><?php echo $List_LH->idLoaiHang . ". " . $List_LH->tenLoaiHang?></option>
         </select>
      </div>
      <div class="mg-bottom">
         <p>Giá</p>
